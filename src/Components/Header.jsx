...
function Headerr() {
  ...
  const [isVisible, setIsVisible] = useState(false); // State to control header visibility
  ...
  return (
    <div
      className={`bg-white w-[100%] shadow-lg fixed top-[0px] z-10 transition-transform duration-500 ${
        isVisible ? "translate-y-0  " : "-translate-y-full "
      }`}
    >
      <header className="cont flex h-[80px]  bg-inherit justify-between items-center">
        <Link to={"/"}>
